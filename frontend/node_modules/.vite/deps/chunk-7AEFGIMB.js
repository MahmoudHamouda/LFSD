...
setVersion("@fluentui/theme", "2.7.1");
...
var FLUENT_CDN_BASE_URL = "https://res.cdn.office.net/files/fabric-cdn-prod_20251010.003";
...
function useControllableValue(controlledValue, defaultUncontrolledValue, onChange) {
  var _a3 = React25.useState(defaultUncontrolledValue), value = _a3[0], setValue = _a3[1];
  var isControlled2 = useConst(controlledValue !== void 0);
  var currentValue = isControlled2 ? controlledValue : value;
  var valueRef = React25.useRef(currentValue);
  var onChangeRef = React25.useRef(onChange);
...
function useEventCallback(fn) {
  var callbackRef = React26.useRef(function() {
...
function useId(prefix, providedId) {
  var ref = React27.useRef(providedId);
  if (!ref.current) {
...
function useMergedRefs() {
  ...
  var mergedCallback = React28.useCallback(function(value) {
...
function useOnEvent(element, eventName, callback, useCapture) {
  var callbackRef = React29.useRef(callback);
...
function useTarget(target, hostElement) {
  var _a3, _b, _c;
  var previousTargetProp = React32.useRef(void 0);
  var targetRef = React32.useRef(null);
...
var useUnmount = function(callback) {
  var unmountRef = React33.useRef(callback);
...
function useWarnings(options) {
  if (true) {
    ...
    var hasWarnedRef = React34.useRef(false);
...
//# sourceMappingURL=chunk-7AEFGIMB.js.map
