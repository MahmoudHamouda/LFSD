...
function useLoadState(props, imageElement) {
  ...
  var _a3 = React.useState(ImageLoadState.notLoaded), loadState = _a3[0], setLoadState = _a3[1];
...
var ImageBase = React.forwardRef(function(props, forwardedRef) {
  var frameElement = React.useRef(void 0);
  var imageElement = React.useRef(void 0);
...
function useCoverStyle(props, loadState, imageElement, frameElement) {
  ...
  var coverStyle = React.useRef(void 0);
  ...
  function(_super) {
    ...
    function FocusZone2(props) {
      ...
      _this._onMouseDown = function(ev) {
        ...
        while (path.length) {
          target = path.pop();
          if (target && isElementTabbable(target, void 0, _this._inShadowRoot)) {
    ...
    FocusZone2.prototype.componentDidMount = function() {
      ...
      this._inShadowRoot = !!((_a3 = this.context) === null || _a3 === void 0 ? void 0 : _a3.shadowRoot);
...
function _getRectangleFromTarget(target) {
  ...
  var targetRect;
  var left = (_a3 = rectOrPointTarget.left) !== null && _a3 !== void 0 ? _a3 : rectOrPointTarget.x;
...
function useScrollbarAsync(props, root) {
  var async = useAsync();
  var _a3 = React6.useState(false), needsVerticalScrollBarState = _a3[0], setNeedsVerticalScrollBar = _a3[1];
...
function useRestoreFocus(props, root) {
  ...
  var originalFocusedElement = React6.useRef(void 0);
  var containsFocus = React6.useRef(false);
  React6.useEffect(function() {
  ...
  useOnEvent(root, "focus", React6.useCallback(function() {
    containsFocus.current = true;
  }, []), true);
  useOnEvent(root, "blur", React6.useCallback(function(ev) {
...
var Popup = React6.forwardRef(function(propsWithoutDefaults, forwardedRef) {
  ...
  var onKeyDown = React6.useCallback(function(ev) {
    switch (ev.which) {
  ...
  return React6.createElement("div", __assign({ ref: mergedRootRef }, getNativeProps(props, divProperties), { className, role, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, "aria-describedby": ariaDescribedBy, onKeyDown, style: __assign({ overflowY: needsVerticalScrollBar ? "scroll" : void 0, outline: "none" }, style) }), children);
});
...
var useDocumentEx = function() {
  var _a3;
  return (_a3 = useDocument()) !== null && _a3 !== void 0 ? _a3 : typeof document !== "undefined" ? document : void 0;
};
var useWindowEx = function() {
  var _a3;
  return (_a3 = useWindow()) !== null && _a3 !== void 0 ? _a3 : typeof window !== "undefined" ? window : void 0;
};
var getDocumentEx = function(ctx) {
  var _a3, _b;
  return (_b = (_a3 = ctx === null || ctx === void 0 ? void 0 : ctx.window) === null || _a3 === void 0 ? void 0 : _a3.document) !== null && _b !== void 0 ? _b : typeof document !== "undefined" ? document : void 0;
};
var getWindowEx = function(ctx) {
  var _a3;
  return (_a3 = ctx === null || ctx === void 0 ? void 0 : ctx.window) !== null && _a3 !== void 0 ? _a3 : typeof window !== "undefined" ? window : void 0;
};
...
function useBounds(_a3, targetRef, targetWindow) {
  ...
  var _c = React7.useState(false), targetWindowResized = _c[0], setTargetWindowResized = _c[1];
  var cachedBounds = React7.useRef(void 0);
  var getBounds = React7.useCallback(function() {
...
function useMaxHeight(_a3, getBounds, targetRef, positions) {
  var _b;
  var calloutMaxHeight = _a3.calloutMaxHeight, finalHeight = _a3.finalHeight, directionalHint = _a3.directionalHint, directionalHintFixed = _a3.directionalHintFixed, hidden = _a3.hidden, gapSpace = _a3.gapSpace, beakWidth = _a3.beakWidth, isBeakVisible = _a3.isBeakVisible, coverTarget = _a3.coverTarget;
  var _c = React7.useState(), maxHeight = _c[0], setMaxHeight = _c[1];
  ...
  React7.useEffect(function() {
    var _a4;
    var bounds = (_a4 = getBounds()) !== null && _a4 !== void 0 ? _a4 : {};
...
function usePositions(props, hostElement, calloutElement, targetRef, getBounds, popupRef) {
  var _a3 = React7.useState(), positions = _a3[0], setPositions = _a3[1];
  var positionAttempts = React7.useRef(0);
  var previousTarget = React7.useRef(void 0);
  var async = useAsync();
  ...
  var win = useWindowEx();
  var localRef = React7.useRef(void 0);
  var popupStyles;
...
function useDismissHandlers(_a3, positions, hostElement, targetRef, targetWindow) {
  ...
  var isMouseDownOnPopup = React7.useRef(false);
  var async = useAsync();
...
var CalloutContentBase = React7.memo(React7.forwardRef(function(propsWithoutDefaults, forwardedRef) {
  ...
  var hostElement = React7.useRef(null);
  var popupRef = React7.useRef(null);
  var mergedPopupRefs = useMergedRefs(popupRef, popupProps === null || popupProps === void 0 ? void 0 : popupProps.ref);
  var _c = React7.useState(null), calloutElement = _c[0], setCalloutElement = _c[1];
  var calloutCallback = React7.useCallback(function(calloutEl) {
  ...
  return React7.createElement(
    ...
    React7.createElement(
      ...
      beakVisible && React7.createElement("div", { className: classNames2.beak, style: getBeakPosition(positions) }),
      beakVisible && React7.createElement("div", { className: classNames2.beakCurtain }),
      React7.createElement(
        Popup,
        __assign({
...
var CalloutContent = styled(CalloutContentBase, getStyles3, void 0, {
  scope: "CalloutContent"
});

// node_modules/@fluentui/react-portal-compat-context/lib/PortalCompatContext.js
var React8 = __toESM(require_react());
var PortalCompatContext = React8.createContext(void 0);
...
function usePortalCompat() {
  ...
  return (_React_useContext = React8.useContext(PortalCompatContext)) !== null && _React_useContext !== void 0 ? _React_useContext : portalCompatContextDefaultValue;
}
...
var FabricBase = React9.forwardRef(function(props, ref) {
  ...
  var rootElement = React9.useRef(null);
  useApplyThemeToBody(applyThemeToBody, classNames2, rootElement);
  return React9.createElement(React9.Fragment, null, useRenderedContent(props, classNames2, rootElement, ref));
});
...
function useRenderedContent(props, _a3, rootElement, ref) {
  ...
  var renderedContent = React9.createElement(
    FocusRectsProvider,
    { providerRef: rootElement },
    React9.createElement(Root, __assign({ dir: rootDir }, divProps, { className: root, ref: useMergedRefs(rootElement, ref) }))
  );
  if (needsTheme) {
    renderedContent = // eslint-disable-next-line @typescript-eslint/no-deprecated
    React9.createElement(Customizer, { settings: { theme: getFabricTheme(theme, dir === "rtl") } }, renderedContent);
  }
...
var Fabric = styled(FabricBase, getStyles4, void 0, {
  scope: "Fabric"
});
...
var LayerBase = React10.forwardRef(function(props, ref) {
  var registerPortalEl = usePortalCompat();
  var rootRef = React10.useRef(null);
  var mergedRef = useMergedRefs(rootRef, ref);
  var layerRef = React10.useRef(void 0);
  var fabricElementRef = React10.useRef(null);
  var focusContext = React10.useContext(FocusRectsContext);
  var _a3 = React10.useState(false), needRaiseLayerMount = _a3[0], setNeedRaiseLayerMount = _a3[1];
  var focusRectsRef = React10.useCallback(function(el) {
  ...
  var getHost = function(doc, shadowRoot) {
    ...
    if (hostId) {
      ...
      return (_b2 = root.getElementById(hostId)) !== null && _b2 !== void 0 ? _b2 : null;
    } else {
  ...
  var createLayerElement = function() {
    ...
    var shadowRoot = ((_b2 = (_a4 = rootRef.current) === null || _a4 === void 0 ? void 0 : _a4.getRootNode()) === null || _b2 === void 0 ? void 0 : _b2.host) ? (_c2 = rootRef === null || rootRef === void 0 ? void 0 : rootRef.current) === null || _c2 === void 0 ? void 0 : _c2.getRootNode() : void 0;
  ...
  return React10.createElement("span", { className: "ms-layer", ref: mergedRef }, layerRef.current && ReactDOM.createPortal(React10.createElement(
    FocusRectsProvider,
    { layerRoot: true, providerRef: fabricRef },
    React10.createElement(Fabric, __assign({}, !eventBubblingEnabled && getFilteredEvents(), fabricProps, { className: css(classNames2.content, fabricProps === null || fabricProps === void 0 ? void 0 : fabricProps.className), ref: fabricRef }), children)
  ), layerRef.current));
});
...
var Layer = styled(LayerBase, getStyles5, void 0, {
  scope: "Layer",
...
var LayerHost = function(props) {
  ...
  var layerHostId = React11.useState(function() {
    return getId();
  })[0];
  var _a3 = props.id, hostId = _a3 === void 0 ? layerHostId : _a3;
  var layerHostRef = React11.useRef({
    hostId,
    rootRef: React11.useRef(null),
    notifyLayersChanged: function() {
    }
  });
  React11.useImperativeHandle(props.componentRef, function() {
  ...
  return React11.createElement("div", __assign({}, props, { className: css("ms-LayerHost", className), ref: layerHostRef.current.rootRef }));
};

// node_modules/@fluentui/react/lib/components/Callout/Callout.js
var Callout = React12.forwardRef(function(_a3, forwardedRef) {
  var layerProps = _a3.layerProps, doNotLayer = _a3.doNotLayer, rest = __rest(_a3, ["layerProps", "doNotLayer"]);
  var content = React12.createElement(CalloutContent, __assign({}, rest, { doNotLayer, ref: forwardedRef }));
  return doNotLayer ? content : React12.createElement(Layer, __assign({}, layerProps), content);
});
...
var useComponentRef = function(componentRef, previouslyFocusedElement, focusFTZ) {
  React13.useImperativeHandle(componentRef, function() {
    return {
...
var FocusTrapZone = React13.forwardRef(function(propsWithoutDefaults, ref) {
  var _a3;
  var root = React13.useRef(null);
  var firstBumper = React13.useRef(null);
  var lastBumper = React13.useRef(null);
  ...
  var focusElementAsync = React13.useCallback(function(element) {
  ...
  return React13.createElement(
    ...
    React13.createElement("div", __assign({}, bumperProps, { ref: firstBumper })),
    children,
    React13.createElement("div", __assign({}, bumperProps, { ref: lastBumper }))
  );
});
...
var FocusTrapCallout = function(props) {
  return React14.createElement(
    Callout,
    __assign({}, props),
    React14.createElement(FocusTrapZone, __assign({ disabled: props.hidden }, props.focusTrapProps), props.children)
  );
};
...
var renderCheckMarkIcon = function(_a3) {
  var onCheckmarkClick = _a3.onCheckmarkClick, item = _a3.item, classNames2 = _a3.classNames;
...
var renderItemName = function(_a3) {
  var item = _a3.item, classNames2 = _a3.classNames;
...
var renderSubMenuIcon = function(_a3) {
  var item = _a3.item, classNames2 = _a3.classNames, theme = _a3.theme;
  if (hasSubmenu(item)) {
...
var ContextualMenuItemBase = (
  ...
  function(_super) {
    ...
    ContextualMenuItemBase2.prototype.render = function() {
      var _a3 = this.props, item = _a3.item, classNames2 = _a3.classNames;
...
var getItemClassNames = memoizeFunction(function(theme, disabled, expanded, checked, isAnchorLink, knownIcon, itemClassName, dividerClassName, iconClassName, subMenuClassName, primaryDisabled, className) {
  ...
  return mergeStyleSets({
      ...
      !disabled && !expanded && [
        {
          ...
          _a3[".".concat(IsFocusVisibleClassName, " &:focus, .").concat(IsFocusVisibleClassName, " &:focus:hover, :host(.").concat(IsFocusVisibleClassName, ") &:focus, :host(.").concat(IsFocusVisibleClassName, ") &:focus:hover")] = styles.rootFocused, _a3[".".concat(IsFocusVisibleClassName, " &:hover, :host(.").concat(IsFocusVisibleClassName, ") &:hover")] = {
            background: "inherit;"
          }, _a3)
        }
      ],
      ...
      !(disabled || primaryDisabled) && !checked && [
        {
          ...
          _b[":hover ~ .".concat(classNames2.splitMenu)] = styles.rootHovered, _b[":active"] = styles.rootPressed, // eslint-disable-next-line @fluentui/max-len
          _b[".".concat(IsFocusVisibleClassName, " &:focus, .").concat(IsFocusVisibleClassName, " &:focus:hover, :host(.").concat(IsFocusVisibleClassName, ") &:focus, :host(.").concat(IsFocusVisibleClassName, ") &:focus:hover")] = styles.rootFocused, _b[".".concat(IsFocusVisibleClassName, " &:hover, :host(.").concat(IsFocusVisibleClassName, ") &:hover")] = {
            background: "inherit;"
          }, _b)
        }
      ]
      ...
      !disabled && !expanded && [
        {
          ...
          _c[".".concat(IsFocusVisibleClassName, " &:focus, .").concat(IsFocusVisibleClassName, " &:focus:hover, :host(.").concat(IsFocusVisibleClassName, ") &:focus, :host(.").concat(IsFocusVisibleClassName, ") &:focus:hover")] = styles.rootFocused, _c[".".concat(IsFocusVisibleClassName, " &:hover, :host(.").concat(IsFocusVisibleClassName, ") &:hover")] = {
            background: "inherit;"
          }, _c)
        }
      ]
    ...
    splitContainer: [
      ...
      !disabled && !checked && [
        {
          selectors: (_d = {}, // eslint-disable-next-line @fluentui/max-len
          _d[".".concat(IsFocusVisibleClassName, " &:focus, .").concat(IsFocusVisibleClassName, " &:focus:hover, :host(.").concat(IsFocusVisibleClassName, ") &:focus, :host(.").concat(IsFocusVisibleClassName, ") &:focus:hover")] = styles.rootFocused, _d)
        }
      ]
    ],
    screenReaderText: [
...
function useKeytipData(options) {
  var uniqueId = React17.useRef(void 0);
...
var ContextualMenuAnchor = (
  ...
  function(_super) {
    ...
    ContextualMenuAnchor2.prototype.render = function() {
      var _this = this;
      var _a3 = this.props, item = _a3.item, classNames2 = _a3.classNames, index = _a3.index, focusableElementIndex = _a3.focusableElementIndex, totalItemCount = _a3.totalItemCount, hasCheckmarks = _a3.hasCheckmarks, hasIcons = _a3.hasIcons, expandedMenuItemKey = _a3.expandedMenuItemKey, onItemClick = _a3.onItemClick, openSubMenu = _a3.openSubMenu, dismissSubMenu = _a3.dismissSubMenu, dismissMenu = _a3.dismissMenu;
...
var ContextualMenuButton = (
  ...
  function(_super) {
    ...
    ContextualMenuButton2.prototype.render = function() {
      var _this = this;
      var _a3 = this.props, item = _a3.item, classNames2 = _a3.classNames, index = _a3.index, focusableElementIndex = _a3.focusableElementIndex, totalItemCount = _a3.totalItemCount, hasCheckmarks = _a3.hasCheckmarks, hasIcons = _a3.hasIcons, contextualMenuItemAs = _a3.contextualMenuItemAs, expandedMenuItemKey = _a3.expandedMenuItemKey, onItemMouseDown2 = _a3.onItemMouseDown, onItemClick = _a3.onItemClick, openSubMenu = _a3.openSubMenu, dismissSubMenu = _a3.dismissSubMenu, dismissMenu = _a3.dismissMenu;
      var ChildrenRenderer = ContextualMenuItem;
...
var getStyles6 = function(props) {
  var theme = props.theme, getClassNames8 = props.getClassNames, className = props.className;
  if (!theme) {
    throw new Error("Theme is undefined or null.");
  }
  if (getClassNames8) {
    var names = getClassNames8(theme);
    return {
...
var ContextualMenuSplitButton = (
  ...
  function(_super) {
    ...
    ContextualMenuSplitButton2.prototype.render = function() {
      ...
      var ariaChecked = (_a3 = getIsChecked(item)) !== null && _a3 !== void 0 ? _a3 : void 0;
    ...
    ContextualMenuSplitButton2.prototype._renderSplitPrimaryButton = function(item, classNames2, index, hasCheckmarks, hasIcons) {
      ...
      return React22.createElement(
        ...
        React22.createElement(ChildrenRenderer, __assign({ "data-is-focusable": false, item: __assign(__assign({}, itemProps), { onClick: item.onClick }), classNames: classNames2, index, onCheckmarkClick: hasCheckmarks && onItemClick ? onItemClick : void 0, hasIcons }, itemComponentProps))
      );
    };
    ...
    ContextualMenuSplitButton2.prototype._renderSplitIconButton = function(item, classNames2, index, keytipAttributes) {
      var _a3 = this.props, onItemMouseLeave = _a3.onItemMouseLeave, onItemMouseDown2 = _a3.onItemMouseDown, openSubMenu = _a3.openSubMenu, dismissSubMenu = _a3.dismissSubMenu, dismissMenu = _a3.dismissMenu;
      var ChildrenRenderer = ContextualMenuItem;
      if (this.props.item.contextualMenuItemAs) {
        ChildrenRenderer = composeComponentAs(this.props.item.contextualMenuItemAs, ChildrenRenderer);
      }
...
var useResponsiveMode = function(elementRef, overrideResponsiveMode) {
  var _a3 = React25.useState(getInitialResponsiveMode()), lastResponsiveMode = _a3[0], setLastResponsiveMode = _a3[1];
...
function useSubMenuState(_a3, dismiss) {
  ...
  var _b = React27.useState(), expandedMenuItemKey = _b[0], setExpandedMenuItemKey = _b[1];
  var _c = React27.useState(), submenuTarget = _c[0], setSubmenuTarget = _c[1];
  var _d = React27.useState(), shouldFocusOnContainer = _d[0], setShouldFocusOnContainer = _d[1];
  ...
  var openSubMenu = React27.useCallback(function(_a4, target, focusContainer) {
...
function usePreviousActiveElement(_a3, targetWindow, hostElement) {
  ...
  var previousActiveElement = React27.useRef(void 0);
...
function useKeyHandlers(_a3, dismiss, hostElement, openSubMenu) {
  ...
  var lastKeyDownWasAltOrMeta = React27.useRef(void 0);
...
function useScrollHandler(asyncTracker) {
  ...
  var scrollIdleTimeoutId = React27.useRef(void 0);
...
var ContextualMenuBase = React27.memo(React27.forwardRef(function(propsWithoutDefaults, forwardedRef) {
  ...
  var renderNormalItem = function(item, classNames3, index, focusableElementIndex, totalItemCount, hasCheckmarks2, hasIcons2) {
    ...
    if (item.href) {
      ...
      return React27.createElement(ContextualMenuAnchorAs, __assign({}, commonProps, { onItemClick: onAnchorClick }));
    }
    if (item.split && hasSubmenu(item)) {
      ...
      return React27.createElement(ContextualMenuSplitButtonAs, __assign({}, commonProps, { onItemClick, onItemClickBase, onTap: cancelSubMenuTimer }));
    }
    ...
    return React27.createElement(ContextualMenuButtonAs, __assign({}, commonProps, { onItemClick, onItemClickBase }));
  };
  ...
  return mergeStyleSets(styles.__shadowConfig__, {
    root: [
      ...
      isExpanded && [
        "is-expanded",
        styles.rootExpanded,
        (_a3 = {}, _a3[":hover .".concat(classNames2.msButtonIcon)] = styles.iconExpandedHovered, // menuIcon falls back to rootExpandedHovered to support original behavior
        _a3[":hover .".concat(classNames2.msButtonMenuIcon)] = styles.menuIconExpandedHovered || styles.rootExpandedHovered, _a3[":hover"] = styles.rootExpandedHovered, _a3)
      ],
      hasMenu && [ButtonGlobalClassNames.msButtonHasMenu, styles.rootHasMenu],
      disabled && ["is-disabled", styles.rootDisabled],
      !disabled && !isExpanded && !checked && (_b = {
        ":hover": styles.rootHovered
      }, _b[":hover .".concat(classNames2.msButtonLabel)] = styles.labelHovered, _b[":hover .".concat(classNames2.msButtonIcon)] = styles.iconHovered, _b[":hover .".concat(classNames2.msButtonDescription)] = styles.descriptionHovered, _b[":hover .".concat(classNames2.msButtonMenuIcon)] = styles.menuIconHovered, _b[":focus"] = styles.rootFocused, _b[":active"] = styles.rootPressed, _b[":active .".concat(classNames2.msButtonIcon)] = styles.iconPressed, _b[":active .".concat(classNames2.msButtonDescription)] = styles.descriptionPressed, _b[":active .".concat(classNames2.msButtonMenuIcon)] = styles.menuIconPressed, _b),
...
var BaseButton = (
  ...
  function(_super) {
    ...
    BaseButton2.prototype.render = function() {
      var _a3;
      var _b = this.props, ariaDescription = _b.ariaDescription, ariaLabel = _b.ariaLabel, ariaHidden = _b.ariaHidden, className = _b.className, disabled = _b.disabled, allowDisabledFocus = _b.allowDisabledFocus, primaryDisabled = _b.primaryDisabled, _c = _b.secondaryText, secondaryText = _c === void 0 ? this.props.description : _c, href = _b.href, iconProps = _b.iconProps, menuIconProps = _b.menuIconProps, styles = _b.styles, checked = _b.checked, variantClassName = _b.variantClassName, theme = _b.theme, toggle = _b.toggle, getClassNames8 = _b.getClassNames, role = _b.role;
      var menuHidden = this.state.menuHidden;
      var isPrimaryButtonDisabled = disabled || primaryDisabled;
      this._classNames = getClassNames8 ? getClassNames8(theme, className, variantClassName, iconProps && iconProps.className, menuIconProps && menuIconProps.className, isPrimaryButtonDisabled, checked, !menuHidden, !!this.props.menuProps, this.props.split, !!allowDisabledFocus) : getBaseButtonClassNames(theme, styles, className, variantClassName, iconProps && iconProps.className, menuIconProps && menuIconProps.className, isPrimaryButtonDisabled, !!this.props.menuProps, checked, !menuHidden, this.props.split);
...
var getStyles9 = memoizeFunction(function(theme, customStyles) {
  var _a3, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s;
  ...
  var splitButtonStyles = {
    splitButtonContainer: [
      getFocusStyle(theme, { highContrastStyle: buttonHighContrastFocus, inset: 2, pointerEvents: "none" }),
      {
        ...
        }, _a3[HighContrastSelector] = __assign(__assign({ color: "WindowText", backgroundColor: "Window", border: "1px solid WindowText", borderRightWidth: "0" }, getHighContrastNoAdjustStyle()), { ":hover": {
        ...
        ".ms-Button--default + .ms-Button": (_b = {}, _b[HighContrastSelector] = {
        ...
        '.ms-Button--default + .ms-Button[aria-expanded="true"]': (_c = {}, _c[HighContrastSelector] = {
          backgroundColor: "HighlightText",
          borderColor: "Highlight",
          color: "Highlight",
          ".ms-Button-menuIcon": __assign({ backgroundColor: "HighlightText", color: "Highlight" }, getHighContrastNoAdjustStyle())
        ...
        '.ms-Button--primary + .ms-Button[aria-expanded="true"]': (_e = {}, _e[HighContrastSelector] = __assign(__assign({ backgroundColor: "Highlight", borderColor: "Highlight", color: "HighlightText" }, getHighContrastNoAdjustStyle()), { ".ms-Button-menuIcon": {
          color: "HighlightText"
        } }), _e),
    ...
    splitButtonContainerChecked: {
      ".ms-Button--primary": (_j = {}, _j[HighContrastSelector] = __assign({ color: "Window", backgroundColor: "WindowText" }, getHighContrastNoAdjustStyle()), _j)
    },
    splitButtonContainerCheckedHovered: {
      ".ms-Button--primary": (_k = {}, _k[HighContrastSelector] = __assign({ color: "Window", backgroundColor: "WindowText" }, getHighContrastNoAdjustStyle()), _k)
    },
    ...
    splitButtonDivider: __assign(__assign({}, splitButtonDividerBaseStyles2), (_m = {}, _m[HighContrastSelector] = {
      backgroundColor: "WindowText"
    }, _m)),
    splitButtonDividerDisabled: __assign(__assign({}, splitButtonDividerBaseStyles2), (_o = {}, _o[HighContrastSelector] = {
    ...
    splitButtonContainerDisabled: (_s = {
      outline: "none",
      border: "none"
    }, _s[HighContrastSelector] = __assign({ color: "GrayText", borderColor: "GrayText", backgroundColor: "Window" }, getHighContrastNoAdjustStyle()), _s),
...
function primaryStyles(theme) {
  ...
  return {
    ...
    }, _a3[HighContrastSelector] = __assign({ color: "Window", backgroundColor: "WindowText", borderColor: "WindowText" }, getHighContrastNoAdjustStyle()), _a3[".".concat(IsFocusVisibleClassName, " &:focus, :host(.").concat(IsFocusVisibleClassName, ") &:focus")] = {
      ":after": {
        border: "none",
    ...
    }, _c[HighContrastSelector] = __assign({ color: "Window", backgroundColor: "WindowText", borderColor: "WindowText" }, getHighContrastNoAdjustStyle()), _c),
    rootExpanded: {
      backgroundColor: s.primaryButtonBackgroundPressed,
      color: s.primaryButtonTextPressed
    },
...
var getStyles12 = memoizeFunction(function(theme, customStyles, primary) {
  ...
  var primaryCompoundTheme = {
    description: (_a3 = {
      color: palette.white
    }, _a3[HighContrastSelector] = __assign({ backgroundColor: "WindowText", color: "Window" }, getHighContrastNoAdjustStyle()), _a3),
    ...
    descriptionPressed: (_c = {
      color: "inherit"
    }, _c[HighContrastSelector] = __assign({ color: "Window", backgroundColor: "WindowText" }, getHighContrastNoAdjustStyle()), _c),
    descriptionChecked: (_d = {
      color: "inherit"
    }, _d[HighContrastSelector] = __assign({ color: "Window", backgroundColor: "WindowText" }, getHighContrastNoAdjustStyle()), _d),
...
var getStyles14 = memoizeFunction(function(theme, customStyles, focusInset, focusColor) {
  ...
  var commandButtonStyles = {
    ...
    }, _h[HighContrastSelector] = __assign({ color: "GrayText" }, getHighContrastNoAdjustStyle()), _h), _g[HighContrastSelector] = __assign({ color: "GrayText", backgroundColor: "Window" }, getHighContrastNoAdjustStyle()), _g),
    // Split button styles
    ...
    splitButtonMenuButtonDisabled: (_o = {
      backgroundColor: p.white
    }, _o[HighContrastSelector] = __assign({ color: "GrayText", border: "none", backgroundColor: "Window" }, getHighContrastNoAdjustStyle()), _o),
    splitButtonMenuButtonChecked: {
      backgroundColor: p.neutralLight,
      color: p.neutralDark,
      ":hover": {
...
//# sourceMappingURL=chunk-MDIZ6XKS.js.map
