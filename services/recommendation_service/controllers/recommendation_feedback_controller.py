...
recommendation_feedback_controller = Blueprint('recommendation_feedback_controller', __name__)

@recommendation_feedback_controller.route('/recommendation_feedback', methods=['POST'])
