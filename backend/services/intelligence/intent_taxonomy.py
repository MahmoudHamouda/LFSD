...
WEALTH_INTENTS = [
    ...
    IntentEntry(
        ...
        regex_patterns=(
            r"can i (?:afford|buy|spend)",
            r"should i (?:buy|invest|spend)",
        ),
    ...
    IntentEntry(
        ...
        dimensions=("wealth",),
        default_tier=0,
        keywords=("net worth", "total assets", "how much am i worth", "asset summary"),
...
TIME_INTENTS = [
    IntentEntry(
        ...
        regex_patterns=(
            r"(?:schedule|book|allocate).*(?:hours|minutes|tomorrow|week)",
        ),
    ...
    IntentEntry(
        ...
        dimensions=("time",),
        default_tier=0,
        keywords=("deadline", "due date", "remind me", "reminder", "don't forget"),
...
MOBILITY_INTENTS = [
    ...
    IntentEntry(
        ...
        regex_patterns=(
            r"book.*(?:uber|careem|ride|cab|taxi)",
            r"(?:take|get) me (?:to|a)",
            r"ride to",
        ),
...
for _entry in ALL_INTENTS:
    for _pattern_str in _entry.regex_patterns:
        _COMPILED_PATTERNS.append(
            (re.compile(_pattern_str, re.IGNORECASE), _entry.name)
        )
