...
class FinanceService:
    ...
    def get_net_worth(self, user_id: str) -> float:
        ...
        if InvestmentPortfolio:
            portfolios = (
                self.db.query(InvestmentPortfolio)
    ...
    def add_transaction(
        ...
        direction = transaction_data.get(
            "direction", "DEBIT"
        ).upper()  # Default to expense if unspecified
        ...
        transaction = FinancialTransaction(
            ...
            transaction_date=(
                datetime.fromisoformat(transaction_data.get("date"))
    ...
    def get_monthly_summary(self, user_id: str) -> dict:
        ...
        for txn in transactions:
            ...
            if amount > 0:
                ...
                if (
                    cat_primary in bill_categories
                    or cat_detailed in bill_categories
                    or txn.is_recurring
                ):
        ...
        return {
            ...
            "recurring_bills": round(
                recurring_bills, 2
            ),  # This is a subset/highlight, not added to expenses
