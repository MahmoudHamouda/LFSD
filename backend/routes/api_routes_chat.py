...
def start_chat(data: ChatStartRequest, db: Session = Depends(get_db)):
    ...
    return {"message": "Chat session started", "session_id": new_session.session_id}
...
async def handle_message(
    ...
    try:
        ...
        return {"response": ai_content, "usage": token_usage}
