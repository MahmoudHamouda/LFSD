...
result = subprocess.run(
    ["python", "tests/e2e/run_journeys.py"], capture_output=True, text=True, cwd="."
)
...
print(
    f"E2E Tests: {'✅ SUCCESS' if result.returncode == 0 else '❌ FAILURES DETECTED'}"
)
print("=" * 70)
