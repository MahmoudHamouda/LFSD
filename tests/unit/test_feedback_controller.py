...
from services.chat_service.controllers.feedback_controller import submit_feedback, get_feedback

class TestFeedbackController(unittest.TestCase):
    @patch("services.chat_service.controllers.feedback_controller.FeedbackRepository")
    def test_submit_feedback_success(self, MockFeedbackRepository):
        ...
        data = {"message_id": "123", "user_id": 1, "feedback": "Great response!"}
    ...
    def test_get_feedback_success(self, MockFeedbackRepository):
        ...
        mock_repo.get_feedback_by_message_id.return_value = [
            {"user_id": 1, "feedback": "Great response!", "created_at": "2024-11-30"}
        ]
